...
export class SyntheticQueryWorker extends PollingWorker {
  constructor() {
    super({
      name      : "SyntheticQueryWorker",
      intervalMs: MEMORY_CONFIG.syntheticQuery?.intervalMs ?? 5000
    });
